<?php 
	$home_pro_master = $action_product->getProductCatDetail_byId(463,$lang);
	$img_sub_master = json_decode($home_pro_master['productcat_sub_img1']);//var_dump($img_sub);
	$home_pro_master_sub = $action_product->getProductCat_byProductCatIdParent_Limit(463, 'desc', 4);
?>
...
<div class="container">
    <div class="gb-slideshow_mptoto wow slideInUp cat-dongsanpham" data-wow-duration="1s">
	    <div class="gb-slideshow_mptoto-slide owl-carousel owl-theme">
	        <?php 
	          foreach ($img_sub_master as $item) {
	    ...
	    <h2><a href="/<?= $home_pro_master['friendly_url'] ?>" title="" style="color: black;"><?= $home_pro_master['productcat_name'] ?></a></h2>
	</div>

	<div class="sanpham-dongsanpham">
		<div class="row">
			<?php foreach ($home_pro_master_sub as $item) { ?>
			<div class="col-sm-3">
